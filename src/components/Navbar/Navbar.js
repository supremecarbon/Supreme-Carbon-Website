    ...
    return (
        <nav className="navbar bg-base-100 p-4">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost normal-case text-2xl font-bold"><Link activeClass="text-white" to="home" spy={true} smooth={true} offset={-70} duration={500}>Supreme Carbon</Link></a>
